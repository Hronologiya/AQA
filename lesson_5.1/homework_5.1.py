...
# Доступ до критерію пошуку
year_min, engine_min, price_max = search_criteria

# Фільтрація автомобілів на основі критеріїв пошуку
filtered_cars = [
    (name, details)
...
# Виведення до п'яти перших знайдених автомобілів
for car in sorted_cars[:5]:
    print(f"Назва: {car[0]}, Колір: {car[1][0]}, Рік: {car[1][1]}, Об'єм двигуна: {car[1][2]}, Тип: {car[1][3]}, Ціна: {car[1][4]} грн")
