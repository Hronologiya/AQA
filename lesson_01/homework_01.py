...
total_trees = apple_trees + plum_trees + pear_trees
print(f"усього {total_trees} дерев")
...
print(f"Надвечір {t_evening} градусів")
...
print(f"Сьогодні {total_children_today} дітей у театральному гуртку")
